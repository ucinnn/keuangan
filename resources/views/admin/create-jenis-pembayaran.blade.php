<x-layout-admin>
    ...
    <head>
        ...
        <title>Manajemen Data Jenis Pembayaran</title>
        ...
        <div class="flex flex-col h-screen">
            ...
            <div class="flex-1 p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold">Manajemen Data Jenis Pembayaran</h2>
                    <div class="flex items-center">
                        <p class="mr-4"></p>
                    </div>
                </div>
                <div class="bg-white p-6 rounded shadow-md">
                    <h2 class="text-xl font-bold mb-4 bg-green-500 text-white p-2 rounded">Tambah Data Jenis Pembayaran
                    </h2>
                    ...
                    <form method="POST" action="{{ route('admin.create-jenis-pembayaran-submit') }}">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div class="flex items-center">
                                <label class="w-1/4" for="nama_pembayaran">Nama Pembayaran</label>
                                <input class="w-3/4 p-2 border rounded" id="nama_pembayaran" name="nama_pembayaran"
                                    type="text" value="{{ old('nama_pembayaran') }}" />
                            </div>
                            <div class="flex items-center">
                                <label class="w-1/4" for="tipe_pembayaran">Tipe Pembayaran</label>
                            ...
                            <div class="flex items-center">
                                ...
                                <input class="w-3/4 p-2 border rounded" id="nominal_jenispembayaran"
                                    ...
                                    value="{{ old('nominal_jenispembayaran') }}" />
                            </div>
                            <div class="flex items-center">
