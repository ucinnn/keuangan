<x-layout-admin>
    ...
    <div class="max-w-4xl mx-auto mt-10">
        <div class="bg-white p-6 rounded-lg shadow-md">
            <h2 class="text-2xl font-bold mb-6">Edit Akun User</h2>
            ...
            <form action="{{ route('admin.updateuserrr', $users->id) }}" method="POST" class="space-y-4">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-700">Simpan</button>
                </div>
            </form>
        </div>
    </div>
