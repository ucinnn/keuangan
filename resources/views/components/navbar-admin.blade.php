...
<aside id="sidebar-multi-level-sidebar" class=" w-64 h-screen" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        <div class="p-4 flex items-center">
            <img alt="User profile picture" class="rounded-full" height="50"
                src="https://storage.googleapis.com/a1aa/image/kwosBKRE4cJBEJ5NfM7aO4iWZlWhQLil3F70R0lBe5YQaU8TA.jpg"
                width="50" />
