...
<li>
    ...
    <ul id="dropdown-kelas"
        ...
        <li>
            <a href="{{ route('admin.manage-kelas') }}"
                ...
                {{ request()->routeIs('admin.manage-kelas') || request()->routeIs('admin.create-kelas') || request()->routeIs('admin.update-kelas') ? 'bg-green-900' : '' }}">
                <!-- Ikon CRU -->
                <svg class="w-4 h-4 me-2 text-green-700 dark:text-white" xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
            <a href="{{ route('admin.perpindahan-kelas') }}"
                class="flex items-center w-full p-2 text-green-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-100 dark:text-white dark:hover:bg-green-700
                {{ request()->routeIs('admin.perpindahan-kelas') ? 'bg-green-900' : '' }}">
                <!-- Ikon Perpindahan -->
                <svg class="w-4 h-4 me-2 text-green-700 dark:text-white" xmlns="http://www.w3.org/2000/svg"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <x-nav-link href="{{ route('admin.manage-data-siswa') }}" :active="request()->routeIs('admin.manage-data-siswa')">
        ...
        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" 
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="currentColor" aria-hidden="true">
...
<li>
    <x-nav-link href="{{ route('admin.manage-jenis-pembayaran') }}" :active="request()->routeIs('admin.manage-jenis-pembayaran')">
        ...
        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 576 512" aria-hidden="true">
        ...
        <span class="flex-1 ms-3 whitespace-nowrap">Manage Pemasukan</span>
        <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300"></span>
    </x-nav-link>
</li>
...
<li>
    <x-nav-link href="{{ route('admin.manage-data-kas') }}" :active="request()->routeIs('admin.manage-data-kas')">
        ...
        <span class="flex-1 ms-3 whitespace-nowrap">Manage Jenis Kas</span>
        <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300"></span>
    </x-nav-link>
</li>
