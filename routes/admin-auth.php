...
use App\Http\Controllers\Admin\Auth\JenisPengeluaranController;
...
use App\Http\Controllers\admin\Auth\PindahKelasController;
...
Route::prefix('admin')->middleware('auth:admin', 'verified')->group(function () {
    ...
    Route::get('/dashboard', action: [DashboardController::class, 'showUser'])->name('admin.dashboard');

    Route::middleware('auth')->group(function () {
        Route::get('/perpindahan-kelas', [PindahKelasController::class, 'index'])->name('admin.perpindahan-kelas');
        Route::post('/submitpindahkelas', [PindahKelasController::class, 'store'])->name('admin.pindahkelas');
        Route::get('/pindahkelasupdate', [PindahKelasController::class, 'updateStatus'])->name('admin.updatepindahkelas');
    });
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/create-jenis-pengeluaran', action: [JenisPengeluaranController::class, 'creates'])->name('admin.create-jenis-pengeluaran');
        Route::get('/jenis-pengeluaran', action: [JenisPengeluaranController::class, 'showDatas'])->name('admin.jenis-pengeluaran');
        Route::post('/jenis-pengeluaran', [JenisPengeluaranController::class, 'submit'])->name('admin.submit-jenis-pengeluaran');
        Route::get('/admin/search', [JenisPengeluaranController::class, 'search']);
        Route::get('/admin/filter-jenis-pengeluaran', [JenisPengeluaranController::class, 'filterDatas'])->name('admin.filter-jenis-pengeluaran');
        Route::post('/create-jenis-pengeluaran', action: [JenisPengeluaranController::class, 'stores'])->name('admin.create-jenis-pengeluaran-submit');
        Route::get('/edit-jenis-pengeluaran/{id}', [JenisPengeluaranController::class, 'editDatas'])->name('admin.edit-jenis-pengeluaran');

        Route::post('/update-jenis-pengeluaran/{id}', [JenisPengeluaranController::class, 'updateDatas'])->name('admin.update-jenis-pengeluaran');
    });
